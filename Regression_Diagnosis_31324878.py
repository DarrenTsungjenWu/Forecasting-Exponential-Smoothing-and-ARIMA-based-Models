...
for i in range(len(EAFV_test)):
    ...
    #Check the composition of 29th FTSE prediction value on test set 
    #29 is obtained from the code print(EE)
    if i == 29:  
        print(vv1[i])
        print(vv2[i])
        print(vv3[i])
...
#Check the results of this codes first and find out where the prediction on test set 
#start to become severly biased   
print(EE)
